-- Deprecate the delete-account edge function in favor of a DB RPC.
...
comment on function public.soft_delete_my_account(uuid) is
  'Preferred account deactivation RPC. Replaces the deprecated delete-account edge function.';
